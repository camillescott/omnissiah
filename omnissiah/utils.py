...
GAMEDATA_DIR = os.path.join(__pkg_dir__, 'gamedata')
...
def default_database_dir(debug=False):
    if not debug:
        return xdg_data_home().joinpath('omnissiah', 'databases')
    else:
        return xdg_data_home().joinpath('omnissiah', 'debug', 'databases')


def default_log_file(debug=False):
    if not debug:
        return xdg_data_home().joinpath('omnissiah', 'omnissiah.log')
    else:
        return xdg_data_home().joinpath('omnissiah', 'debug', 'omnissiah.log')
